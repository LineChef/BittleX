...
CHALLENGES = {
    ...
    "rubble":            {"RUBBLE": 0.016, "RUBBLE_N": 550, "RUBBLE_PROB": 1.0},   # rough but passable -- 15mm cap
    "rubble-hard":       {"RUBBLE": 0.022, "RUBBLE_N": 780, "RUBBLE_PROB": 1.0},   # denser + bigger chunks
